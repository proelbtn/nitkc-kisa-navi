...
_SOUVENIR = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=souvenir_dot_messages__pb2._SOUVENIRDELETERESULT,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='Get',
